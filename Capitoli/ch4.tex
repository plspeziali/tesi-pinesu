...
\begin{itemize}
    ...
    \item \emph{Strong}: Si controlla la blockchain, tramite PineSU SM (\autoref{chap:sm}), per verificare che sia presente la entry corrispondente alla chiusura di quella SU.
\end{itemize}
