...
\begin{enumerate}
    ...
    \item Potremmo scegliere di chiudere la nostra Storage Unit,
    ...
    \item Potremmo scegliere di sincronizzare la SU nella blockchain,
...
due possibili azioni da poter compiere: la verifica d'integrità, sia offline che online,
l'esportazione di sottoinsiemi di file dalla SU, tutti muniti con i dati necessari per
effettuare verifiche d'integrità da parte di terzi anche senza disporre dell'intera SU.
...
stati di una singola storgae unit riflette le operazioni appena descritte.
