...
\section{VCS e Git}
\label{sub:vcs}
Un \textbf{Version Control System} (o anche VCS), in italiano “sistema di controllo di versione”,
...
Ogni risorsa in una repository è identificata internamente dal suo checksum (SHA-1) e non dal suo nome,
...
\label{sub:hash}
Le funzioni di hashing sono funzioni non invertibili che
permettono di associare in maniera univoca (o quasi) stringhe
di caratteri (e quindi anche documenti di varia natura tradotti 
in stringhe) a delle stringhe alfanumeriche di lunghezza fissa
TODOTODOTODOTODO
