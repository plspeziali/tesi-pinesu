...
\begin{frame}
	...
	\begin{columns}
		...
		processo che richiede l'attuazione di un piano di \textbf{digitalizzazione}.	
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	Realizzare uno \textbf{software} che combini \textbf{Git} con una \textbf{blockchain} e ci consenta vi verificare in maniera sicura
\end{frame}
...
\begin{frame}
	...
	\begin{columns}[T]
		...
		Software \textbf{Open Source}, esso agevola la gestione \textbf{distribuita} di insiemi\\di file e directory.
...
\begin{frame}
	...
	contenitori immutabili chiamati \textbf{\emph{blocchi}}, collegati l'uno all'altro come in una
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{enumerate}
			...
			\item Registrazione dell'impronta su un \textbf{blocco} della blockchain.
			\item Acquisizione dell'\textbf{impronta digitale della transazione} e del \textbf{timestamp}.
		\end{enumerate}
	\end{columns}
\end{frame}
